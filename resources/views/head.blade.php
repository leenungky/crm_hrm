 <title>Pengiriman</title>
	...
	<script type="text/javascript" src="{{ URL::asset('js/jquery.contextMenu.js') }}"></script>	
	<script type="text/javascript" src="{{ URL::asset('js/jquery.ui.position.min.js') }}"></script>	

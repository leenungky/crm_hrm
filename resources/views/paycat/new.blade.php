		...
		<div class="row">				
			<div class="col-md-12">											
					<div class="row">	
						...
						<div class="col-md-5">
							<form method="post" action="/pcat/create" class="formsubmit">
							...
							<div class="form-group">
							    ...
							    <textarea class="form-control" id="formula" rows="8" name="formula" placeholder="Input description" required>{{ old('formula') }}</textarea>	
							</div>										
